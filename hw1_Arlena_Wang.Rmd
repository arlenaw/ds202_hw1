...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer:
    Hello, my name is **Arlena Wang** and I am 2nd year student majoring in *Food Science*.  I am planning to get a minor in data science, which is why I am taking this class.  I am from Illinois and I like to hangout with friends.  
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer:
    I think any type of job could be related to data science as it is important to analyze data for anything in order to improve.  Since my major is Food Science, I could use data science for [Food Science at Kraft Heinz Company](https://www.indeed.com/viewjob?jk=e5c8d2d883fc26be&tk=1fe33cepvu413800&from=serp&vjs=3), for example. As you can see [Kraft Heinz](https://s.abcnews.com/images/Business/ht_heinz_chart_kab_150325_16x9_992.jpg) is a merge from two very wellknown food companies which still have data scientists helping to analyze and improve their company.  
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer:
    I am not sure which data topic I will be most intereted.  Maybe data on movies or sports?  
